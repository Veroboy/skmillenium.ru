@extends('admin.layouts.millenium_admin', ['title' => 'Редактирование статьи'])
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><b>Редактирование: </b>{{ $post->title }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <form action="{{route('admin.post.update', $post->id)}}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="summernote" name="content" rows="20">
                              {{ $post->content }}
                           </textarea>
                                        @error('content')
                                        <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2" name="tag_ids[]" multiple="multiple"
                                                data-placeholder="Выбирите теги" style="width: 100%;">
                                            @foreach($tags as $tag)
                                                <option
